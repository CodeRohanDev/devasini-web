...
export const coreLeadership: LeaderProfile[] = [
    ...
    },
    {
        ...
        fullBio: [
            'Pia Devasini serves as Vice President, leading strategic initiatives and business development efforts.',
            ...
            'Pia brings fresh perspectives and innovative approaches to the firm\'s growth strategy.',
        ],
